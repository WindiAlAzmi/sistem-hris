...
export default function Pelatihan() {
   return (
      <div className=" mt-20  md:mt-10  pt-6">
      <div className="block p-6 items-center justify-between border-b border-gray-200 bg-white  dark:border-gray-700 dark:bg-gray-800 sm:flex">
...
const AddProductModal = () => { 
  ...
  return (
    <>
      <Button  className="bg-gray-100 text-black" onClick={() => setOpen(!isOpen)}>
        <FaPlus className="mr-3 text-sm" />
         Tambah Pelatihan
      </Button>
      <Modal onClose={() => setOpen(false)} show={isOpen}>
        <Modal.Header className="border-b border-gray-200 !p-6 dark:border-gray-700">
          <strong>TambahPelatihan</strong>
        </Modal.Header>
        <Modal.Body>
          <form>
